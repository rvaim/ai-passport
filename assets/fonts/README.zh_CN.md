...
- 字体源文件：锁定的 LVGL 9.5.0 依赖自带的 [`NotoSansSC-Regular.ttf`](https://github.com/lvgl/lvgl/blob/v9.5.0/tests/src/test_files/fonts/noto/NotoSansSC-Regular.ttf)
- 许可证：[SIL Open Font License 1.1](https://github.com/lvgl/lvgl/blob/v9.5.0/tests/src/test_files/fonts/noto/OFL.txt)
- 操作图标源：[`FontAwesome5-Solid+Brands+Regular.woff`](https://github.com/lvgl/lvgl/blob/v9.5.0/scripts/built_in_font/FontAwesome5-Solid+Brands+Regular.woff)，只合入上、下两个图标
- 操作图标许可证：[Font Awesome Free license](https://github.com/lvgl/lvgl/blob/v9.5.0/scripts/built_in_font/font_license/FontAwesome5/LICENSE.txt)
